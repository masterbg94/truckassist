...
@Component({
  selector: 'app-payment-fali-modal',
  templateUrl: './payment-fali-modal.component.html',
  styleUrls: ['./payment-fali-modal.component.scss'],
})
export class PaymentFaliModalComponent implements OnInit {
  @Input() inputData: any;
  ...
  loadInitData(): void {
    ...
    this.unmarkedTitle = this.inputData.data.unmarkedTitle;
