...
@Component({
  selector: 'app-add-card-account-modal',
  templateUrl: './add-card-account-modal.component.html',
  styleUrls: ['./add-card-account-modal.component.scss'],
})
export class AddCardAccountModalComponent implements OnInit {
  @Input() inputData: any;
