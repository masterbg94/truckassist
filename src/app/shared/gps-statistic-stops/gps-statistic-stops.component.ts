...
@Component({
  selector: 'app-gps-statistic-stops',
  templateUrl: './gps-statistic-stops.component.html',
  styleUrls: ['./gps-statistic-stops.component.scss']
})
export class GpsStatisticStopsComponent implements OnInit {
 @Input() isGps: boolean;
